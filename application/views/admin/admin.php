            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <label for="adminListPerPage">trên một trang</label>
                    </div>
                    <div class="col-sm-4 form-inline form-group-sm">
                        <label for="adminListSortBy" class="control-label">Xắp xếp theo theo</label> 
                        <select id="adminListSortBy" class="form-control">
                            <option value="first_name-ASC" selected>Theo bảng chữ cái (A -> Z)</option>
                            <option value="first_name-DESC">Theo bảng chữ cái (Z -> A)</option>
                            <option value="created_on-ASC">Ngày tạo (quá khứ đến hiện tại)</option>
                            <option value="created_on-DESC">Ngày tạo (hiện tại đến quá khứ)</option>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class='modal-header'>
                ...
                <h4 class="text-center">Thêm quản trị viên</h4>
            ...
            <div class="modal-body">
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='lastName' class="control-label">Tên đệm và tên</label>
            ...
            <div class="modal-footer">
                <button type="reset" form="addNewAdminForm" class="btn btn-warning pull-left">Reset lại thông tin đã nhập</button>
                <button type='button' id='addAdminSubmit' class="btn btn-primary">Xác nhận thêm quản trị viên</button>
...
<div class='modal fade' id='editAdminModal' role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class='modal-header'>
                <button class="close" data-dismiss='modal'>&times;</button>
                <h4 class="text-center">Chỉnh sửa thông tin quản trị viên</h4>
                <div class="text-center">
                    <i id="fMsgEditIcon"></i>
            ...
            <div class="modal-body">
                <form id='editAdminForm' name='editAdminForm' role='form'>
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='lastNameEdit' class="control-label">Tên đệm và tên</label>
            ...
            <div class="modal-footer">
                <button type="reset" form="editAdminForm" class="btn btn-warning pull-left">Reset thông tin đã nhập</button>
