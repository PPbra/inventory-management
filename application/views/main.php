    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbarCollapse" aria-expanded="false">
                        <span class="sr-only">Mở danh sách điều hướng</span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                    </button>
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        <img src="https://img.icons8.com/ios-glyphs/100/000000/home-page.png" alt="logo" class="img-responsive" width="73px">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav navbar-left visible-xs">
                        ...
                        <li class="<?= $pageTitle == 'Database' ? 'active' : '' ?>">
                            <a href="<?= site_url('dbmanagement') ?>">
                                ...
                                Quản lý dữ liệu (Nếu không cần thiết không vào phần này)
                            </a>
                        </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Tổng số tiền đã bán hôm nay: <b>VNĐ <span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a href="http://www.amirsanni.com">Ngo Minh Phuong</a> (2019)
            </p>
        </footer>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h4 class="text-center">Biên lai giao dịch</h4>
                    </div>
